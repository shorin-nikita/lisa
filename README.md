...
1. **llama3** — основная языковая модель (Llama 3 8B)
   - Размер: ~4.7 GB
...
> 💡 **Рекомендация:** Для минимальной конфигурации (2 CPU / 8GB RAM) используйте легкие модели **llama3.2:1b** или **phi3.5:mini**. Для рекомендуемой конфигурации (4+ CPU / 12GB RAM) подойдут **llama3**, **mistral** или **llama3.1:8b**.
