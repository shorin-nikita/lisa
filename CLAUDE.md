...
- Default allocation: Ollama 40%, PostgreSQL 20%, N8N 15%, Qdrant 10%
...
**Лимиты памяти для 8GB RAM:**
| Сервис | RAM | CPU | Назначение |
|--------|-----|-----|------------|
| Ollama | 2.5GB | 50% | LLM модели |
| PostgreSQL | 1.5GB | 25% | Supabase |
| N8N | 1GB | 20% | Workflow engine |
| N8N Runners | 768MB | 15% | Code ноды (JS/Python) |
| Qdrant | 512MB | 10% | Векторы |
